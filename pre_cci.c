# 1 "c:\\users\\mmahe\\onedrive\\desktop\\new folder\\jpetstore_sc01_addtocart\\\\combined_JpetStore_SC01_AddToCart.c"
...
# 1 "c:\\users\\mmahe\\onedrive\\desktop\\new folder\\jpetstore_sc01_addtocart\\\\combined_JpetStore_SC01_AddToCart.c" 2
...
Action()
{
			...
			
	{
		...
		lr_end_transaction("JpetStore_SC01_TC01_Launch",0);
	}
		else
    {  
	   lr_output_message("Invalid Response");
       lr_end_transaction("JpetStore_SC01_TC01_Launch",2);
       lr_abort();
	}
	...
	{
		lr_output_message("Valid Response");
		lr_end_transaction("JpetStore_SC01_TC02_Signin",0);
	}
		else
    {  
	   lr_output_message("Invalid Response");
       lr_end_transaction("JpetStore_SC01_TC02_Signin",2);
       lr_abort();
	}
	...
	{
		lr_output_message("Valid Response");
		lr_end_transaction("JpetStore_SC01_TC03_Login",0);
	}
		else
    {  
	   lr_output_message("Invalid Response");
       lr_end_transaction("JpetStore_SC01_TC03_Login",2);
       lr_abort();
	}
	...
	{
		lr_output_message("Valid Response");
		lr_end_transaction("JpetStore_SC01_TC04_Click_On_Fish",0);
	}
		else
    {  
	   lr_output_message("Invalid Response");
       lr_end_transaction("JpetStore_SC01_TC04_Click_On_Fish",2);
       lr_abort();
	}
	...
	{
		lr_output_message("Valid Response");
		lr_end_transaction("JpetStore_SC01_TC05_Click_On_Product_ID",0);
	}
		else
    {  
	   lr_output_message("Invalid Response");
       lr_end_transaction("JpetStore_SC01_TC05_Click_On_Product_ID",2);
       lr_abort();
	}
	...
	{
		lr_output_message("Valid Response");
        lr_end_transaction("JpetStore_SC01_TC06_Click_On_EST-3",0);
	}
		else
    {  
	   lr_output_message("Invalid Response");
       lr_end_transaction("JpetStore_SC01_TC06_Click_On_EST-3",2);
       lr_abort();
	}
	...
	{
		lr_output_message("Valid Response");
        lr_end_transaction("JpetStore_SC01_TC07_cloick_On_Add_To_Cart",0);
	}
		else
    {  
	   lr_output_message("Invalid Response");
       lr_end_transaction("JpetStore_SC01_TC07_cloick_On_Add_To_Cart",2);
       lr_abort();
	}
	...
	{
		lr_output_message("Valid Response");
       lr_end_transaction("JpetStore_SC01_TC08_Click_On_Product_To_Checkout",0);
	}
		else
    {  
	   lr_output_message("Invalid Response");
       lr_end_transaction("JpetStore_SC01_TC08_Click_On_Product_To_Checkout",2);
       lr_abort();
	}
	...
	{
		lr_output_message("Valid Response");
        lr_end_transaction("JpetStore_SC01_TC09_Click_On_Continue",0);
	}
		else
    {  
	   lr_output_message("Invalid Response");
       lr_end_transaction("JpetStore_SC01_TC09_Click_On_Continue",2);
       lr_abort();
	}
	...
	{
		lr_output_message("Valid Response");
        lr_end_transaction("JpetStore_SC01_TC10_Click_On_Confirm",0);
	}
		else
    {  
	   lr_output_message("Invalid Response");
       lr_end_transaction("JpetStore_SC01_TC10_Click_On_Confirm",2);
       lr_abort();
	}
	...
	{
		lr_output_message("Valid Response");
        lr_end_transaction("JpetStore_SC01_TC11_Click_On_Sign_Out",0);
	}
		else
    {  
	   lr_output_message("Invalid Response");
       lr_end_transaction("JpetStore_SC01_TC11_Click_On_Sign_Out",2);
       lr_abort();
	}
